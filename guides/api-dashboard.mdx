---
title: "API Dashboard: Manage Keys, Auth, and Usage Tracking"
sidebarTitle: "API Dashboard"
description: "Create and revoke SuperCompress API keys, monitor per-key token usage, and authenticate requests against the hosted compress endpoint."
---

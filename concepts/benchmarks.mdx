---
title: "SuperCompress Benchmark Results and Methodology"
...
`sustainability_from_tokens_saved` converts tokens saved into illustrative GPU-seconds, watt-hours, and CO₂ using documented assumptions from `SustainabilityAssumptions`:

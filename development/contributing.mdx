---
title: "Contributing to SuperCompress"
...
6. **Verify web assets** — asserts that `model.json`, `benchmarks.json`, `compress-engine.js`, `chart-kv-savings.svg`, `chart-impact.svg`, and `launch.mp4` all exist under `web/assets/`

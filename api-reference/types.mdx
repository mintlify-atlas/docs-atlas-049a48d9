---
title: "SuperCompress Python Types and Data Classes"
sidebarTitle: "Types"
...
<ResponseField name="kv_savings_pct" type="float">
  **Computed property.** Percentage of KV-cache entries eliminated: `(1 − kept_tokens / original_tokens) × 100`. Returns `100.0` when `original_tokens` is zero to avoid division by zero.
</ResponseField>
